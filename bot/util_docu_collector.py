...
def generate_documentation():
	...
	for a in patched_files:
		subprocess.call("cat "+ a +" >> document.3", shell=True, cwd = "./man/man3")
	...
	subprocess.call("perl -pi -w -e 's/Generated automatically by Doxygen for My Project from the source code./Generated by CRABOT./g;' manpage.txt", shell=True, cwd = "./man/man3")
