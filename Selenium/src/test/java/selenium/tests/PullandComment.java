...
//	       }
	       //change these values
	       int i = 3;
	       String patchNo = "patch-3";
	       //end change these values
	       driver.get("https://github.com/KakanotCollaborator/Repo1");
	       WebElement PR1 = driver.findElement(By.xpath("//*[@id='js-repo-pjax-container']/div[2]/div[1]/div[4]/a"));
	       ...
	       if(PR1 != null)
	       {
	    	   ...
	    	   WebElement listBranches = driver.findElement(By.xpath("//*[@id='js-repo-pjax-container']/div[2]/div[1]/div[1]/div[3]/div[2]/div[2]/button/span"));
	   		   listBranches.click();
	    	   wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='js-repo-pjax-container']/div[2]/div[1]/div[1]/div[3]/div[2]/div[2]/div/div/div[3]/div[1]/a["+i+"]/div")));
	    	   WebElement branchLatest = driver.findElement(By.xpath("//*[@id='js-repo-pjax-container']/div[2]/div[1]/div[1]/div[3]/div[2]/div[2]/div/div/div[3]/div[1]/a["+i+"]/div"));

	    	   branchLatest.click();
	    	  // System.out.println(branchLatest.getText());
	    	   driver.get("https://github.com/codekaka/Repo1/compare/master...KakanotCollaborator:KakanotCollaborator-"+patchNo);
	    	   WebElement PR2 = driver.findElement(By.xpath("//*[@id='js-repo-pjax-container']/div[2]/div[1]/div[2]/div/button"));
	    	   PR2.click();
	    	   WebElement PR3 = driver.findElement(By.xpath("//*[@id='new_pull_request']/div[2]/div/div/div[3]/button"));
	    	   PR3.click();
	       }
	}
