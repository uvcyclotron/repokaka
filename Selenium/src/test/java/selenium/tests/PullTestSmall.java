	...
	public void testCrabot() throws Exception
	{
	       ...
	       if(PR1 != null)
	       {
	    	   ...
	    	   branchLatest.click();
	   		   ...
	   		   wait = new WebDriverWait(driver, 30);
	   		   wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[2]/div[1]/div[2]/div/button")));
	    	   ...
	    	   List <WebElement> btns = driver.findElements(By.xpath("//button[@class='btn btn-primary']"));
				...
				String commentText = "Testing happy case for small commit size: @codekaka Run all";
				...
				commentText = "Testing alternative case for small commit size: @codekaka Run s1,s2";
				commentOnPR(commentText);
				Thread.sleep(15000);	//wait for crabot to comment.
